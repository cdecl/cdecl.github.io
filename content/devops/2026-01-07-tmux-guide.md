...
> **참고**: 이 가이드에 소개된 키 바인딩은 `tmux`의 기본 설정입니다. `~/.tmux.conf` 파일을 수정하여 자신만의 키 바인딩을 설정할 수 있으며, 특히 [Oh My Tmux](https://github.com/gpakosz/.tmux)와 같은 프레임워크를 사용하면 키 설정이 크게 달라질 수 있습니다.
