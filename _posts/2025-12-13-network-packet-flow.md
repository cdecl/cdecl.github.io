...
```text
+----------------+        +----------------+        +-----------------------+
|   Source PC    | -----> |   L2 Switch    | -----> | Default Gateway (L3)  |
| (192.168.1.10) |        | (Check MAC)    |        | (Check Routing Table) |
+----------------+        +----------------+        +-----------------------+
        ^                         |                             |
        | ARP (IP -> MAC)         |                             |
        +-------------------------+                             |
                                                    ...
                                                    +-----------------------+
                                                                ...
                                                                v
+----------------+        +----------------+        +-----------------------+
|    Dest PC     | <----- |   L2 Switch    | <----- |  Dest Gateway (L3)    |
| (203.0.113.50) |        | (Check MAC)    |        | (Check Routing Table) |
+----------------+        +----------------+        +-----------------------+
```
